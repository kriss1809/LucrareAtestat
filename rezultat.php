...
<body>
    ...
    <div class="container p-5 mt-5 mb-5" style="background-image: linear-gradient(to bottom right, LightSteelBlue, PaleTurquoise); border-radius: 21px;">
        <div class="row">
                ...
                <div style="font-size:36px">
                    <strong>
                        <?php
                             ...
                             {
                                 ?>
                                    <div>Ai răspuns corect la <span style="color:red"> <?=$_SESSION['total']?> </span> întrebări!</div>
                                 <?php
                             }
                             if(isset($limba) && $limba==="eng")
                             {
                                 ?>
                                   <div>You answered <span style="color:red"> <?=$_SESSION['total']?> </span> questions correctly!</div>
                                 <?php
                             }
                             if(isset($limba) && $limba==="fr")
                             {
                                 ?>
                                    <div>Tu as répondu correctement à <span style="color:red"> <?=$_SESSION['total']?> </span> questions !</div>
                                 <?php
                             }
                             if(isset($limba) && $limba==="es")
                             {
                                 ?>
                                   <div>Respondiste <span style="color:red"> <?=$_SESSION['total']?> </span> preguntas correctamente!</div>
                                 <?php
                             }
                        ?>
                    </strong>
                ...
                <div style="background-color: black; color:white; border-radius: 10px; font-size:20px;" class="p-2 mt-2">
                    <a href="biografie.php"> 
                        <?php
                              ...
                              {
                                  ?>
                                    <span>Citește biografia autoarei</span>
                                  <?php
                              }
                              if(isset($limba) && $limba==="eng")
                              {
                                  ?>
                                    <span>Read Agatha Christie's biography</span>
                                  <?php
                              }
                              if(isset($limba) && $limba==="fr")
                              {
                                  ?>
                                    <span>Lis la biographie d'Agatha Christie</span>
                                  <?php
                              }
                              if(isset($limba) && $limba==="es")
                              {
                                  ?>
                                    <span>Lea la biografía de Agatha Christie</span>
                                  <?php
                              }
                        ?>
                    </a>
            ...
            ?>
            <div class="col-4">
                <div class="text-center" style="background-image: linear-gradient(to right, #c7b0de, plum);  border-radius: 21px;">
