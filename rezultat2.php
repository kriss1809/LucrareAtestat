...
<body>
    ...
    <div class="container p-5 mt-5 mb-5" style="background-image: linear-gradient(to bottom right, #c7b0de, #e6dbf0); border-radius: 21px;">
        <div class="row">
            ...
            <div style="font-size:36px">
                <strong>
                    <?php
                        ...
                        {
                            ?>
                            <div>Ai răspuns corect la <span style="color:red"> <?=$_SESSION['total2']?> </span> întrebări!</div>
                            <?php
                        }
                        if(isset($limba) && $limba==="eng")
                        {
                            ?>
                            <div>You answered <span style="color:red"> <?=$_SESSION['total2']?> </span> questions correctly!</div>
                            <?php
                        }
                        if(isset($limba) && $limba==="fr")
                        {
                            ?>
                            <div>Tu as répondu correctement à <span style="color:red"> <?=$_SESSION['total2']?> </span> questions !</div>
                            <?php
                        }
                        if(isset($limba) && $limba==="es")
                        {
                            ?>
                            <div>Respondiste <span style="color:red"> <?=$_SESSION['total2']?> </span> preguntas correctamente!</div>
                            <?php
                        }
                    ?>
                </strong>
                ...
                <div style="background-color: black; color:white; border-radius: 10px; font-size:20px;" class="p-2 mt-2">
                    <a href="carti.php"> 
                        <?php
                              if(isset($limba) && $limba==="ro")
                              {
                                  ?>
                                    <span>Citește despre cărțile autoarei</span>
                                  <?php
                              }
                              if(isset($limba) && $limba==="eng")
                              {
                                  ?>
                                    <span>Read about Agatha Christie's books</span>
                                  <?php
                              }
                              if(isset($limba) && $limba==="fr")
                              {
                                  ?>
                                    <span>Découvrez les livres d'Agatha Christie</span>
                                  <?php
                              }
                              if(isset($limba) && $limba==="es")
                              {
                                  ?>
                                    <span>Lea sobre los libros de Agatha Christie</span>
                                  <?php
                              }
                        ?>
                    </a>
            ...
            <div class="col-4">
                ...
                <div class="text-center mt-3" style="background-image: linear-gradient(to right, red , yellow);  border-radius: 21px;">
                    <a href="intrebare3.php?nr=<?=$_SESSION['contor3']?>">
                        <div class="pb-3 pt-3">
                            <div class="p-2">
                                <h3 style="color: black">Quiz 3</h3>
                                <p><?=$text3?></p>
                            </div>
